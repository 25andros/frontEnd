//rebuild of api's as objects instead of instaniated functions
...
class mmI {
  constructor(type, id, height, width, source, controls) {
    {
      this.type=type;
...
let vidElement = new mmI(
  "video",
  "vid2Name",
  400,
  400,
  //"~/cat/frontEnd/siteOne/media/videos/stol_vet.mp4",
    "../siteOne/media/videos/stol_vet.mp4",
  true
);
...
function eventWindowLoaded() {
  ...
  document.createElement(vidElement.type);
  document.createElement(vidElement);
